...
{
    public class MessageProviderStateHandler
    {
        private FakeRecipeRepository _recipeRepository;

        public MessageProviderStateHandler(FakeRecipeRepository recipeRepository)
        {
